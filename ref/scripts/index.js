...
captureBtn.addEventListener("click", function(event) {
  ...
  if (count < 6) {
    document.querySelector(
      ".msg"
    ).innerHTML = `<p>Captured ${selectPokemon.innerText}, explore to find more pokemon</p>`;
    captureHtml += `<div class='mypoke'>${selectPokemon.innerHTML}${
      document.querySelector(".pokePic").innerHTML
    }</div>`;
